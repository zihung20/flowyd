...
| Page                                                     | Covers                                                                                                                                                                                                             |
| -------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [WorkflowBuilder](./workflow-builder)                    | `createWorkflow`, `defineAction`, `setContext`, `addStep`, `addFork`, `addJoin`, `addWait`, `setInitial`, `setTerminal`, `addTransition`, `build`, `createInstance`, `restoreInstance`                             |
| [WorkflowInstance & DispatchResult](./workflow-instance) | `dispatch`, `canExecute`, `getCurrentStates`, `getStateStatus`, `isTerminal`, `getAvailableTransitions`, `injectGuard`, `getSnapshot`, `resolveWait`, `getContext`, `setContext`, `rewind`, `DispatchResult` union |
